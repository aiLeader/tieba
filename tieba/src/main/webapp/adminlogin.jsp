			...
			<div id="large-header" class="large-header">
				...
				<div id="loginDiv">
					<form id="loginForm" action="admin/login" method="post">
						...
						<p>
							<input class="easyui-textbox" name="aid" prompt="请用账号/邮箱/手机号码登录" data-options="iconCls:'icon-man',iconAlign:'left'" style="width:300px"> 
						</p>
						<p>
						<input class="easyui-textbox"type="password" name="apassword" prompt="请输入密码" data-options="iconCls:'icon-lock',iconAlign:'left'" style="width:300px"> 
						</p>
						<p>
